...
DR2_L = np.array([2.e-3,12.e-3,12.e-3,2.e-3,2.e-3])
DR2_T = np.array([1.e-3,1.e-3,4.e-3,2.e-3,1.e-3])
...
pss.fill_polygon(DR2_L,DR2_T,int(mats[0]))
...
pss.save_general_mesh(fname='meso_m_bowtest2_{}x{}.iSALE'.format(T_cells,L_cells),mixed=False,noVel=True)
